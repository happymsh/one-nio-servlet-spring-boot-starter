 ...
 */
public class OneNioServletRegistration extends AbstractNIOServletRegistration implements ServletRegistration.Dynamic {
    private final Logger log = LoggerFactory.getLogger(getClass());
    private volatile boolean initialised;
    private Servlet servlet;
    private Collection<String> urlPatternMappings = new LinkedList<>();

    public OneNioServletRegistration(OneNioContext context, String servletName, String className, Servlet servlet) {
    ...
    public Set<String> addMapping(String... urlPatterns) {
        ...
        OneNioContext context = getOneNioContext();
