 ...
 */
public class OneNioFilterRegistration extends AbstractNIOServletRegistration implements FilterRegistration.Dynamic {
    private volatile boolean initialised;
    private Filter filter;
    private Collection<String> urlPatternMappings = new LinkedList<>();

    public OneNioFilterRegistration(OneNioContext context, String filterName, String className, Filter filter) {
